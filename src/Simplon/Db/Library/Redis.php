<?php
    ...
    class Redis
    {
        ...
        public function listGetDataByRange($key, $indexStart, $limit)
        {
            ...
            $response = $this->_query($this->_getListGetValuesByRangeQuery($key, $indexStart, $limit));
        ...
        public function listMultiGetDataByRange(array $keys, $indexStart, $limit)
        {
            ...
            {
                $limit = $this->_calcRangeLimit($indexStart, $limit);
                $this->_pipelineAddQueueItem($this->_getListGetValuesByRangeQuery($key, $indexStart, $limit));
            }
        ...
        public function sortedSetGetDataByRange($key, $indexStart, $limit)
        {
            ...
            $response = $this->_query($this->_getSortedSetGetDataByRangeQuery($key, $indexStart, $limit));
        ...
        public function sortedSetReverseGetDataByRange($key, $indexStart, $limit)
        {
            ...
            $response = $this->_query($this->_getSortedSetReverseGetDataByRangeQuery($key, $indexStart, $limit));
